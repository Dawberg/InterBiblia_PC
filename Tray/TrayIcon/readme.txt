...
Refer to CoolTrayIcon.html, TextTrayIcon.html, and install.txt for documentation.

See also convert_my_projects.txt if you're upgrading from a previous version
